...
Version  : 2.13.2
Release  : 35
URL      : https://files.pythonhosted.org/packages/60/5b/2de097ad2af32b1f53ffc293f2cb9e9160d414d86995248709cc1dbe567c/imageio-2.13.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/60/5b/2de097ad2af32b1f53ffc293f2cb9e9160d414d86995248709cc1dbe567c/imageio-2.13.2.tar.gz
...
%prep
%setup -q -n imageio-2.13.2
cd %{_builddir}/imageio-2.13.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638887131
...
cp %{_builddir}/imageio-2.13.2/LICENSE %{buildroot}/usr/share/package-licenses/imageio/c3f3ee58b67ca6a8d73f562dd42eda4e897eb1c0
