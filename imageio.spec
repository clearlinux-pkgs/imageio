...
Version  : 2.11.0
Release  : 31
URL      : https://files.pythonhosted.org/packages/dd/e3/082923e66fbb59ed3ae280dc98f428191346a91c313783cb4f79b0858130/imageio-2.11.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/dd/e3/082923e66fbb59ed3ae280dc98f428191346a91c313783cb4f79b0858130/imageio-2.11.0.tar.gz
...
%prep
%setup -q -n imageio-2.11.0
cd %{_builddir}/imageio-2.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637252188
...
cp %{_builddir}/imageio-2.11.0/LICENSE %{buildroot}/usr/share/package-licenses/imageio/c3f3ee58b67ca6a8d73f562dd42eda4e897eb1c0
